...
# cfg.LR_g = 1e-3
# cfg.LR_f = 1e-3
# cfg.final_actv = 'Prelu'
# cfg.TRIAL = 21.11
# cfg.schedule_hchange_bool = 1
# cfg.load = 1
...
"""""""""""""""""""""""""""""""""""""""""""""""""""
train_data = g_data.marginal_data_color_transfer_ficnn(cfg)
train_loader = torch.utils.data.DataLoader(
    train_data, batch_size=cfg.BATCH_SIZE, shuffle=False, **kwargs)
# PLU.plot_rgb_cloud_alone(train_data[:, :, 0], results_save_path + '/dst1.png')
...
def train(epoch):
    ...
    for batch_idx, real_data in enumerate(train_loader):
        ...
        # print("generator_h.activ.weight")
        # print(generator_h.activ.weight)
        if cfg.schedule_hchange_bool == False:
            optimizer_h.step()
...
for epoch in range(1, cfg.epochs + 1):
    ...
    if epoch % 1 == 0:
        LLU.dump_nn(generator_h, convex_f, convex_g, epoch,
                    model_save_path, num_distribution=cfg.NUM_DISTRIBUTION)
