...
"""""""""""""""""""""""""""""""""""""""""""""""""""
train_data, gaussian_mean, gaussian_cov = g_data.marginal_usps_3loop_ficnn_handle(
    cfg)
    ...
    for batch_idx, real_data in enumerate(train_loader):
        ...
        if cfg.convolution_flag is True:
            ...
            epsilon = g_data.torch_samples_generate_Gaussian(
                cfg.BATCH_SIZE, gaussian_mean, gaussian_cov)
...
for epoch_realtrain in range(1, cfg.epochs + 1):
    ...
    if epoch_realtrain % 10 == 0:
        LLU.dump_nn(generator_h, convex_f, convex_g,
                    epoch_realtrain, model_save_path, num_distribution=cfg.NUM_DISTRIBUTION, save_f=cfg.save_f)
